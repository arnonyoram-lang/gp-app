...
function mgrReload(){
  const c=document.getElementById('mgrTabCand'),o=document.getElementById('mgrTabCon');
  if(c)c.className=(mgrView=='cand'?'primary':'ghost');
  if(o)o.className=(mgrView=='con'?'primary':'ghost');
  if(mgrView=='con')loadCon();else loadMgr();
}
...
function renderMgr(){ if(mgrView=='con')renderContractors(); else renderCandidates(); }
